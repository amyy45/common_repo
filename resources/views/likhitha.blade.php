...
<nav class="navbar navbar-expand-lg bg-color py-4 pt-lg-5">
    <div class="container">
        <a class="navbar-brand text-white fw-bold" href="#">Likhitha's Website</a>
    ...
    <section class="container ">
        <div class="row">
            ...
            <div class="col-xl-6 xol-lg-6 col-md-12 col-12  d-flex flex-column justify-content-center align-items-start ">
                ...
                <p class="mt-3 mb-5 para-width text-light-grey">
                    Creating a successful digital product involves several key steps. Let’s dive into them:

                    Brainstorm Ideas: Start by brainstorming profitable digital product ideas. Don’t wait for inspiration; actively explore topics that resonate with your audience12.
                    Validate Your Ideas: Assess the viability of your product concepts. Consider market trends, demand, and competition. Validate your ideas by researching similar products and understanding their success2.
                    Market Research: Understand your target audience. What problems do they face? How can your product solve those problems? Conduct thorough market research to refine your concept1.
                </p>
        ...
        <div class="row g-5">
            ...
            <div class="col-xl-6 col-md-12 ">
                <div class="d-flex  px-3 py-5 shadow ">
                    ...
                    <div class="row ">
                        <p class="mb-3 fw-bolder">Digital Marketing</p>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/a.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Mia Miller</p>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/b.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Ana Sebastein</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/c.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Georgia Miller</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/d.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Niha Kellner</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/f.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Ginny Miller</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/g.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Clara klien</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class=" mt-3 d-flex justify-content-center">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    <img alt="..."
                                         ...
                                         src="./images/h.png">
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Lili Edith</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                        ...
                        <div class="col-xxl-4">
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="card  p-3" style="width: 18rem;">
                                    ...
                                    <div class="card-body text-center">
                                        <p class="card-title  mb-3">Amelia Eleanor</p>
                                        <p class="card-text">Some quick example text to build on the card title and make
                                            up
                                            the bulk of the card's content.</p>
                                        <div class="d-flex justify-content-center">
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="small text-grey "><i class="fa-solid fa-book-open-reader"></i> : 4500 </p>
                                <p class="small text-grey "> January 3, 2021 </p>
                            </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="small text-grey "><i class="fa-solid fa-book-open-reader"></i> : 6000 </p>
                                <p class="small text-grey ">Feb 5 ,2022 </p>
                            </div>
                            <h5 class=" mt-3 card-title">Digital Marketing</h5>
                            <p class="card-text mt-2 mb-3">Digital Marketing Specialists should compare your company’s advertising techniques and offerings with those of competing businesses.</p>
                            <a class="px-4 py-2 btn btn-dark" href="#">Read More</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="small text-grey "><i class="fa-solid fa-book-open-reader"></i> : 5500 </p>
                                <p class="small text-grey "> March 7, 2023 </p>
                            </div>
                    ...
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <p class="small text-grey "> May 8, 2021</p>
                            </div>
                            <h5 class=" mt-3 card-title">Data Engineer</h5>
                            <p class="card-text mt-2 mb-3">Join our dynamic CRM data engineering team as a full-time engineer, where you will have the opportunity to work on big data .</p>
                            <a class="px-4 py-2 btn btn-dark" href="#">Read More</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="form-section  mx-auto">
            <form>
                ...
                <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text text-white">This remains Confidential with us.
                    </div>
                </div>
                <div class="mb-3">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-12 ">
                    Copyright ©2024 All rights reserved. | This template is made with by <span class="bg-theme"> SoftwareTechnical.com</span>
                </div>
